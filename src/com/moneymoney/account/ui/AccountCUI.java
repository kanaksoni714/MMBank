...
//	private static void updateAccount(String accountHolderName,
//			boolean salary) {
//		savingsAccountService.updateAccount(accountHolderName, salary);
//		
//	}

//	private static void deleteAccount(int choice) throws ClassNotFoundException, SQLException {
//		System.out.println("Enter Account Number: ");
//		int accountNumberToBeDeleted = scanner.nextInt();
//		System.out.println("Changes are permanent. Are u sure?(y/n): ");
//		boolean confirmation = scanner.next().equalsIgnoreCase("n")?false:true;
//		try {
//			Object delete = savingsAccountService.getAccountById(accountNumberToBeDeleted);
...
//			e.printStackTrace();
//		}
//		savingsAccountService.deleteAccount(accountNumberToBeDeleted);
//		
//	}
